    ...
    _HtmlTemplates = {
      ...
      chrome:   '<div id="epiceditor-wrapper" class="epiceditor-edit-mode">' +
                  ...
                  '<div id="epiceditor-utilbar">' +
                    (self._previewEnabled ? '<img width="30" src="' + this.settings.basePath + 'preview.png" title="' + this.settings.string.togglePreview + '" class="epiceditor-toggle-btn epiceditor-toggle-preview-btn"> ' : '') +
                    (self._editEnabled ? '<img width="30" src="' + this.settings.basePath + 'edit.png" title="' + this.settings.string.toggleEdit + '" class="epiceditor-toggle-btn epiceditor-toggle-edit-btn"> ' : '') +
                    (self._fullscreenEnabled ? '<img width="30" src="' + this.settings.basePath + 'fullscreen.png" title="' + this.settings.string.toggleFullscreen + '" class="epiceditor-fullscreen-btn">' : '') +
                  '</div>' +
                '</div>'
